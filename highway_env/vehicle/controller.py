...
class ControlledVehicle(Vehicle):
    ...
    def __init__(self, v_id,
                 ...
                 route: Route = None):
        super().__init__(v_id, road, position, heading, speed)
    ...
    def create_from(cls, vehicle: "ControlledVehicle") -> "ControlledVehicle":
        ...
        """
        v = cls(vehicle.id, vehicle.road, vehicle.position, heading=vehicle.heading, speed=vehicle.speed,
...
class MDPVehicle(ControlledVehicle):
    ...
    def __init__(self, v_id,
        ...
        super().__init__(v_id, road, position, heading, speed, target_lane_index, target_speed, route)
